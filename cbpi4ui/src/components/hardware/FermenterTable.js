                ...
                <Table className={classes.table} dense table size="small" aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right" className="hidden-xs">{t("cooler")}</TableCell>
                        ...
                        {state.fermenter.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell align="right" className="hidden-xs">
                                    <DeleteDialog title={t("delete fermenter")} message={t("delete text")} id={row.id} callback={remove_callback} />
